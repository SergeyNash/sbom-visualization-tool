...
### Планируемые функции
- [ ] Поддержка формата SPDX
- [ ] Интеграция с GitHub Actions
- [ ] Сравнение версий SBOM
- [ ] Темная тема
- [ ] Экспорт в PDF
...
- [CycloneDX](https://cyclonedx.org/) - стандарт SBOM
- [D3.js](https://d3js.org/) - библиотека для визуализации
- [Next.js](https://nextjs.org/) - React фреймворк
- [Tailwind CSS](https://tailwindcss.com/) - CSS фреймворк
- [Radix UI](https://www.radix-ui.com/) - компоненты UI

## 📞 Поддержка

- **Issues**: [GitHub Issues](https://github.com/your-username/sbom-visualization-tool/issues)
- **Discussions**: [GitHub Discussions](https://github.com/your-username/sbom-visualization-tool/discussions)
...
**Авторы**: SBOM Visualization Tool Team